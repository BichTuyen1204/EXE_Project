                ...
                >
                  <thead>
                    <tr>
                      ...
                      >
                        Book Id {activeCell === 0 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-1 text-center"
                        onClick={() => handleCellClick(1)}
                      >
                        Name {activeCell === 1 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-1 text-center"
                        onClick={() => handleCellClick(2)}
                      >
                        Image {activeCell === 2 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-2 text-center"
                        onClick={() => handleCellClick(3)}
                      >
                        Place Production {activeCell === 3 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-1 text-center"
                        onClick={() => handleCellClick(4)}
                      >
                        Category {activeCell === 4 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-1 text-center"
                        onClick={() => handleCellClick(5)}
                      >
                        Price {activeCell === 5 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-2 text-center"
                        onClick={() => handleCellClick(6)}
                      >
                        Description {activeCell === 6 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-1 text-center"
                        onClick={() => handleCellClick(7)}
                      >
                        Weight {activeCell === 7 && <FaCaretUp />}
                      </th>
                      <th
                        className="col-1 text-center"
                        onClick={() => handleCellClick(8)}
                      >
                        Quantity {activeCell === 8 && <FaCaretUp />}
                      </th>
                  ...
                  <tbody>
                    {filteredProducts.map((product) => (
                      <tr key={product.idBook}>
                        ...
                        <td className="col-1 align-center img-edit">
                          <img src={`http://localhost:8090/${product.image}`} />{" "}
                        </td>
                        ...
                        <td className="col-1 align-items-center">
                          <div className="d-flex justify-content-center align-items-center col-12 button-order-big">
                            <Button
                              className="btn btn-danger me-2"
                              onClick={() =>
                                handleOpenDeleteModal(product.idBook)
                              }
                            >
                              Delete
                            </Button>
